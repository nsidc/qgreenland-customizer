...
class QGreenlandCustomizer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'QGreenlandCustomizer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&QGreenland Customizer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('QGreenlandCustomizer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/custom_qgreenland/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'QGreenland Customizer'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&QGreenland Customizer'),
                action)
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = QGreenlandCustomizerDialog()
